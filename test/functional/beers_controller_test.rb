...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery: @beer.brewery, name: @beer.name, rating: @beer.rating, style: @beer.style, year: @beer.year }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { brewery: @beer.brewery, name: @beer.name, rating: @beer.rating, style: @beer.style, year: @beer.year }
    assert_redirected_to beer_path(assigns(:beer))
  end
